...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        corn1 = rg.Point(circles[k].center.x - circles[k].radius, circles[k].center.y - circles[k].radius)
        corn2 = rg.Point(circles[k].center.x + circles[k].radius, circles[k].center.y + circles[k].radius)
        tim = rg.Rectangle(corn1, corn2)
        sequence = sequence + [tim]
    return sequence
